...
假如康熙知道哈希函数
![利用哈希防篡改](res/anti_tamper.png)

- 防篡改
- 结果不可逆，可以用于一些事先公布预测结果的场景
...
$美团所有数据库信息 ==> SHA256 ==> 256 位哈希$

如果这个过程可逆的话，我们就发现了一种无敌的压缩算法，可以把全世界的信息压成 256 位 存储。
...
工作量+奖励机制，容易让系统中的节点达成共识，向好的方向发展
